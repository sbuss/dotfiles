...
--
myWorkspaces    = ["term","web","music","code","comm","browser"] ++ map show [7..9]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "exe=`dmenu_path | dmenu -b -nb '#303030' -nf '#909090'` && eval \"exec $exe\"")
...
--
myLayout = layoutHintsToCenter (avoidStruts $ tiled ||| Mirror tiled ||| Full)
  where
...
-- display current workspace as darkgrey on light grey (opposite of default colors)
  { -- ppCurrent         = dzenColor "#303030" "#909090" . pad
    -- ppCurrent         = wrap (dzenColor "#909090" "" "{") (dzenColor "#909090" "" "}") . dzenColor "#FFFFFF" "" . pad
    ppCurrent         = dzenColor ("#FFFFFF") ("") . wrap "[" "]" . pad
...
barFont     = " -fn lucidasans-8"
myConkyBar  = "sleep 2s && conky | dzen2 -x '680' -e '' -fg '#606060' -bg '#303030' -w '1000' -h '20' -ta r" ++ barFont
myStatusBar = "dzen2 -p -ta l -x 0 -y 0 -w 700 -h 20 -fg '#606060' -bg '#303030' -e 'onexit=ungrabmouse'" ++ barFont
